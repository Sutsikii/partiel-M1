    ...
    const loadData = async () => {
      ...
      if (conferenceResult.success && conferenceResult.data) {
        ...
        setFormData({
          ...
          time: conferenceDate.toTimeString().slice(0, 5),
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Modifier les informations de la conférence
          </p>
        </div>
      </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleInputChange("roomId", e.target.value)}
